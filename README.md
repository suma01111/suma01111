...
### Full-Stack Engineer · AI-Assisted Products · Computer Science Student
...
<code>design with clarity · build with purpose · learn continuously</code>

<br /><br />

[![Portfolio](https://img.shields.io/badge/Portfolio-7C3AED?style=for-the-badge&logo=vercel&logoColor=white)]([https://portfolio-tau-sandy-90.vercel.app](https://sunita-choudhary.vercel.app/))
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Languages</h3>
      <p>Core languages I use for application development, scripting, algorithms, and data work.</p>
      <p>
        <img src="https://skillicons.dev/icons?i=js,python,cpp,c" alt="JavaScript, Python, C++, and C" height="46" />
      </p>
      <code>JavaScript</code> <code>Python</code> <code>C++</code> <code>C</code> <code>SQL</code>
    </td>
    <td width="50%" valign="top">
      <h3>Frontend Engineering</h3>
      <p>Responsive interfaces and component-based web experiences with modern tooling.</p>
      <p>
        <img src="https://skillicons.dev/icons?i=react,html,css,vite" alt="React, HTML, CSS, and Vite" height="46" />
      </p>
      <code>React</code> <code>HTML5</code> <code>CSS3</code> <code>Vite</code>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>Backend & APIs</h3>
      <p>Maintainable server-side applications, business logic, and API-driven workflows.</p>
      <p>
        <img src="https://skillicons.dev/icons?i=nodejs,express" alt="Node.js and Express" height="46" />
      </p>
      <code>Node.js</code> <code>Express</code> <code>REST APIs</code>
    </td>
    <td width="50%" valign="top">
      <h3>Databases</h3>
      <p>Relational and document-based data modelling for full-stack applications.</p>
      <p>
        <img src="https://skillicons.dev/icons?i=mongodb,mysql" alt="MongoDB and MySQL" height="46" />
      </p>
      <code>MongoDB</code> <code>MySQL</code> <code>DBMS</code>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>AI & Intelligent Systems</h3>
      <p>Applying AI to practical engineering, documentation, and image-processing workflows.</p>
      <p>🤖 &nbsp; 🧠 &nbsp; 🖼️ &nbsp; ⚙️</p>
      <code>Generative AI</code> <code>LLMs</code> <code>Prompt Engineering</code> <code>Image Processing</code>
    </td>
    <td width="50%" valign="top">
      <h3>Developer Tools</h3>
      <p>Version control, collaboration, deployment, and day-to-day development tools.</p>
      <p>
        <img src="https://skillicons.dev/icons?i=git,github,vercel,vscode" alt="Git, GitHub, Vercel, and VS Code" height="46" />
      </p>
      <code>Git</code> <code>GitHub</code> <code>Vercel</code> <code>VS Code</code>
    </td>
  </tr>
</table>

<details>
  <summary><strong>Computer Science Foundations</strong></summary>
  <br />
  Data Structures & Algorithms · Object-Oriented Programming · Operating Systems · Computer Networks · Software Engineering
</details>
